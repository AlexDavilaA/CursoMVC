...
namespace CapaPresentacionTienda.Controllers
{
    public class TiendaController : Controller
    {
        ...
        public async Task<JsonResult> ProcesarPago(List<Carrito> oListaCarrito, Venta oVenta)
        {
            ...
            detalle_venta.Locale = new System.Globalization.CultureInfo("es-MX");
            ...
            Checkout_Order oCheckOutOrder = new Checkout_Order()
            {
                ...
                application_context = new ApplicationContext()
                {
                    ...
                    user_action = "PAY_NOW",
                    return_url = "https://localhost:44327/Tienda/Pagoefectuado",
                    cancel_url = "https://localhost:44327/Tienda/Carrito"
                }
            ...
            //EL link de momento será estatico
